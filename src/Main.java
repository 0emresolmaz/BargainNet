...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        UserService userService = new UserManager(new HibernateUserDao(), new ValidationManager(new HibernateUserDao(), new GmailManagerAdapter()));

        User user1 = new User(1, "A", "B", "abcoutlook.com", "135", LocalDate.of(1989, 5, 27));

        User user2 = new User(2, "Emre", "Solmaz", "emresolmaz@gmail.com", "13579012", LocalDate.of(1989, 5, 27));

        User user3 = new User(3, "Emre3", "Solmaz", "emresolmaz@gmail.com", "1", LocalDate.of(1989, 5, 27));
        ...
        System.out.println("\n---------------------Login işlemleri--------------------------------");
        String mail1 = "emresolmaz@gmail.com";
        String password1 = "270589";
        userService.Login(mail1, password1);

        String mail2 = "emresolmaz@gmail.com";
